...
export default function SnakeStatic(props: SlateElementProps) {
  const element = props.element as StaticDiagramElement;
  const total = element.children?.length || 1;
        ...
        >
          ...
          >
            ...
            >
              <defs>
                <marker
                  id="presentation-snake-arrow-static"
                  markerHeight="10"
                  markerWidth="10"
                  orient="auto"
                  refX="8"
                ...
                return (
                  <path
                    ...
                    markerEnd={
                      isLast
                        ? undefined
                        : "url(#presentation-snake-arrow-static)"
                    }
              ...
              {total > 0 && (
                <line
                  ...
                  strokeWidth="3"
                  strokeLinecap="round"
                  markerEnd="url(#presentation-snake-arrow-static)"
                />
              )}
            </svg>

            {/* CSS Grid for text items */}
            <div
